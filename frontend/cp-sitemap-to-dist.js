...
axios
  .get("https://social-games-sksayon.herokuapp.com/api/all-sitemap-links")
  .then((response) => {
    if (response.status === 200) {
      ...
      urlArray.push(
        ...
        {
          loc: "https://socail-game.web.app/dare-games/auth",
          changefreq: "yearly",
          priority: 1,
        }
      );
      ...
      var filenm =
        `${process.cwd()}/dist/social-game/browser/` + sitemapXML.file_name;
      var filenm2 =
        `${process.cwd()}/dist/social-game/browser/sitemap/` +
        sitemapXML.file_name;
